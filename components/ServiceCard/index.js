...
const getIconForService = (name) => {
  ...
  } else if (name.includes("Bitcoin") || name.includes("Lightning")) {
    return (
  ...
  } else if (name.includes("Protocol") || name.includes("Cryptography")) {
    return (
...
const ServiceCard = ({ name, description }) => {
  ...
  return (
    <div
      className="w-full bg-gray-900 mob:bg-gray-800 p-6 mob:p-6 rounded-lg transition-all ease-out duration-300 hover:shadow-lg hover:shadow-blue-900/20 border border-gray-800 hover:border-blue-900/50"
    >
